...
from PyQt6.QtWidgets import QGraphicsDropShadowEffect, QInputDialog
...
from proyecto.interfaz.principal import MainWindow
from proyecto.interfaz.ui_generated import Ui_MainWindow 
...
if __name__ == "__main__":
    ...
    num, ok = QInputDialog.getInt(None, "Configuración", "Carriles (3 o 4):", 4, 3, 4)
    if ok:
        ventana = MainWindow(num)
        ventana.show()
        sys.exit(app.exec())